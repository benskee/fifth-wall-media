            ...
            <div>
                <div className="container">
                    ...
                    <div className='row'>
                        ...
                        <ImageLink link='./chartDeck' label='Chart Deck' image='chartDeck' />
                    ...
                    <div className="fwm-bg-gray p-4">
                        <div className="container col-8">
                            <h4 className='fwm-text'><b>First Time?</b></h4><br/>
                            <p>Head over to the <Link to='/code'>Coding Tutorial</Link> to watch a quick demonstration of the Fifth Wall Media Platform. You will see videos come alive and be able to interact directly with the content. While watching the coding tutorial you can select any file of the project and copy the code at the current state of the video.</p>
                        </div>
                    </div>
